...
public class ProgramResourceIntTest {
     ...
     *
     * @see com.brandon.presley.next.episode.repository.search.ProgramSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProgram() throws Exception {
        ...
        assertThat(testProgram.getEpisodeNumber()).isEqualTo(DEFAULT_EPISODE_NUMBER);
        assertThat(testProgram.getEpisodeSeason()).isEqualTo(DEFAULT_EPISODE_SEASON);
        assertThat(testProgram.getEpisodeDate()).isEqualTo(DEFAULT_EPISODE_DATE);
    ...
    public void updateProgram() throws Exception {
        ...
        assertThat(testProgram.getEpisodeNumber()).isEqualTo(UPDATED_EPISODE_NUMBER);
        assertThat(testProgram.getEpisodeSeason()).isEqualTo(UPDATED_EPISODE_SEASON);
        assertThat(testProgram.getEpisodeDate()).isEqualTo(UPDATED_EPISODE_DATE);
