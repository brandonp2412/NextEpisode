...
export class NextEpisodeComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-next-episode div table .btn-danger'));
    title = element.all(by.css('jhi-next-episode div h2#page-heading span')).first();
...
export class NextEpisodeUpdatePage {
    pageTitle = element(by.id('jhi-next-episode-heading'));
...
export class NextEpisodeDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-nextEpisode-heading'));
    private confirmButton = element(by.id('jhi-confirm-delete-nextEpisode'));
