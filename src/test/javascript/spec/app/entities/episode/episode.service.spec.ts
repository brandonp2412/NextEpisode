    ...
    describe('Episode Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/episodes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Episode', () => {
                service.create(new Episode(null)).subscribe(received => {
            ...
            it('should update a Episode', () => {
                service.update(new Episode(123)).subscribe(received => {
